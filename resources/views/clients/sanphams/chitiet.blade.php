                            ...
                            <div class="product-details-des">
                                ...
                                <div class="ratings d-flex">
                                    ...
                                    <div class="pro-review">
                                        <span>{{$sanpham->lươt_xem}}</span>
                                    </div>
                                </div>
                                <div class="price-box">
                                    <span
                                        class="price-regular">{{number_format($sanpham->gia_khuyen_mai,0,'','.')}}đ</span>
                                    <span
                                        class="price-old"><del>{{number_format($sanpham->gia_san_pham,0,'','.')}}đ</del></span>
                                </div>

                                <div class="availability">
                                    <i class="fa fa-check-circle"></i>
                                    Số lượng:<span> {{$sanpham->so_luong}}</span>
                                </div>
                                <p class="pro-desc">Mô tả ngắn :
                                    <br>{{$sanpham->mo_ta_ngan}}
                                </p>
...
$('#quantityInput').on('change', function() {
    var value = parsenInt($(this).val(), 10);
    if (isNaN(value) || value < 1) {
        alert('số luongj phải lớn hơn 1')
        $(this).val(1)
    }
})
</script>
